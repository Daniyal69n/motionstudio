            ...
            <div>
              ...
              <div className="space-y-6">
                <div className="flex items-center gap-4">
                  <div className="w-12 h-12 bg-white rounded-full items-center justify-center flex-shrink-0 hidden sm:flex">
                  ...
                  <div className="max-w-full">
                    ...
                    <p className="text-white text-lg break-words overflow-hidden text-ellipsis">motion.studioteams@gmail.com</p>
                  </div>
                </div>
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div className="max-w-full">
                    ...
                    <p className="text-white text-lg break-words overflow-hidden text-ellipsis">Full-Stack Web Development</p>
                  </div>
                </div>
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div className="max-w-full">
                    ...
                    <p className="text-white text-lg break-words overflow-hidden text-ellipsis">Within 24 Hours</p>
                  </div>
                </div>
              </div>
            </div>
